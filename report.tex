...
%TODO references need to be added.
...
%TODO insert CAS image

%TODO (re)move section 'Displayed information'?
...
%TODO (re)move section 'User Contribution'?
...
%TODO insert image
The main window is where the most time is spent. It consists of several components, see fig <FIGUUR met nummers>.%TODO add ref
\begin{enumerate}
